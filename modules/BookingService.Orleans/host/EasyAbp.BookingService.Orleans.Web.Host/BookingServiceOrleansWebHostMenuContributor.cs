...
public class BookingServiceOrleansWebHostMenuContributor : IMenuContributor
{
    private readonly IConfiguration _configuration;

    public BookingServiceOrleansWebHostMenuContributor(IConfiguration configuration)
    {
    ...
    {
        var l = context.GetLocalizer<BookingServiceResource>();
