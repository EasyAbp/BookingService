 ...
 */
public abstract class BookingServiceOrleansApplicationTestBase : BookingServiceTestBase<BookingServiceOrleansApplicationTestModule>
{
    ...
    protected BookingServiceOrleansApplicationTestBase()
    {
