...
public class BookingServiceCommonWebModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.AddAssemblyResource(typeof(BookingServiceResource), typeof(BookingServiceCommonWebModule).Assembly);
        });
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.AddMaps<BookingServiceCommonWebModule>(validate: true);
        });
