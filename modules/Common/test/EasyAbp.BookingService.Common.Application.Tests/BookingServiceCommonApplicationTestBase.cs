 ...
 */
public abstract class BookingServiceCommonApplicationTestBase : BookingServiceTestBase<BookingServiceCommonApplicationTestModule>
{
    ...
    protected BookingServiceCommonApplicationTestBase()
    {
